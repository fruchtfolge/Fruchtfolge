...
* Static data
set grossMarginAttr / price,yield,directCosts,variableCosts,fixCosts /;
...
parameter p_plotData(curPlots,plotAttr) /
 '2019-01-08T15:24:33.730Z'.size 12.07
 '2019-01-08T15:24:33.730Z'.distance 0.48
 '2019-01-08T15:24:33.730Z'.quality 70.5
/;

set plots_soilTypes(curPlots,soilTypes) /
 '2019-01-08T15:24:33.730Z'.'Tonschluffe (tu)'
/;

set plots_rootCropCap(curPlots) /
 '2019-01-08T15:24:33.730Z' 'YES'
/;
...
parameter p_laborReq(crops,halfMonths) /
 ...
 'Ackergras - Anwelksilage'.MRZ1 2.99
 'Ackergras - Anwelksilage'.MRZ2 0.66
 'Ackergras - Anwelksilage'.MAI2 3.37
 ...
 'Ackergras - Anwelksilage'.OKT1 0.04
 'Ackergras - Anwelksilage'.OKT2 1.83
/;
